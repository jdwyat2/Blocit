class FavoriteMailer < ApplicationMailer
    ...
    def new_post(post)
        headers["Message-ID"] = "<posts/#{post.id}@https://arcane-lake-41434.herokuapp.com/>"
        headers["In-Reply-To"] = "<posts/#{post.id}@https://arcane-lake-41434.herokuapp.com/>"
        headers["References"] = "<posts/#{post.id}@https://arcane-lake-41434.herokuapp.com/>"
